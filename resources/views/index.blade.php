            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        ...
                        <a href="{{ $first_post->featured_image }}" class="link-image js-zoom-image">
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{ $second_post->featured_image }}" alt="{{ $second_post->title }}">
                        <div class="overlay"></div>
                        <a href="{{ $second_post->featured_image }}" class="link-image js-zoom-image">
                            <i class="seoicon-zoom"></i>
                        </a>
                        <a href="#" class="link-post">
                            <i class="seoicon-link-bold"></i>
